        ...
        <thead>
            <tr>
                <th colspan = '2' style='padding-bottom: .40em; padding-top: .50em;'>
                   <center><img src = 'https://d3egtvtajmesev.cloudfront.net/wp-content/uploads/2022/02/08224928/logo-300-ABONAP.png' width='20%' /></center> 
                </th>
            </tr>
        </thead>
        <tbody>
                ...
                <td colspan = '2' >
                    < table border= '1' style= 'width: 100%;' >
                        < tbody  style= 'width: 100%;' >
                            < tr style= 'width: 100%;' >
                                < td style= 'width: 30%;' >
                                    < img style= 'width:25%' src= 'https://d3egtvtajmesev.cloudfront.net/wp-content/uploads/2022/02/08224928/logo-300-ABONAP.png' />
                                </ td >
                                < td >
                                        texto
                                </ td >
